...
Public Sub RunDataPreScrub()
    ...
    wsScrub.Range("A1:I1").Font.Bold = True
    wsScrub.Range("A1:I1").Interior.Color = RGB(220, 230, 241)
    ...
    If fso.FileExists(outputFile) Then
        ...
        ReDim writeData(1 To UBound(lines), 1 To 9) '<-- EXPANDED TO 9
        ...
        If writeCount > 1 Then
            wsScrub.Range("A2").Resize(writeCount - 1, 9).Value2 = writeData
            wsScrub.Columns("A:I").AutoFit
