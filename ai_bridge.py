        ...
        for i_queue, signature in enumerate(ai_queue_phrases): 
            ...
            for c_idx in range(num_candidates): 
                ...
                for idx in top_indices: 
                    ...
                    substring_bonus = 0.1 if lookup_candidate_lower in signature else 0.0 
                     
                    # --- TARGET-DOMINANT MATH ---
                    ...
                    combined_score = (sem_score * 0.50) + (overlap * 0.35) + hidden_pattern_bonus 
